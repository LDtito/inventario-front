...
const Page = ({ params }: { params: { id: string } })  => {
    ...
    const getInitData = async () => {
        if (!entityId || entityId=="0")
            return;
        const { data, error } = await useFetchWithAuth("categoria/" + entityId);
    ...
    <>
        <div className='grow '>
        <Toolbar pathForm='/inventario/categoria/0' pathList='/inventario/categoria/' currentEntity={getValues("nombre")} entityName='categoria'/>
